...
\SetKwInOut{Output}{output}
  ...
  \Output{vector$<$int$>$ dist : un vector con la distancia del camino mínimo entre src y el nodo i
           en dist[i]}
...
que en la demostración de correctitud de Dijkstra no se ahce alusión a...
